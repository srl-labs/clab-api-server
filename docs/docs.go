        ...
        "/api/v1/labs/{labName}/nodes/{nodeName}/logs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Show logs since timestamp (e.g. '2023-01-01T00:00:00Z' or duration like '5m')",
                        "name": "since",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Show logs until timestamp (e.g. '2023-01-01T00:00:00Z' or duration like '5m')",
                        "name": "until",
                        "in": "query"
                    },
                    {
